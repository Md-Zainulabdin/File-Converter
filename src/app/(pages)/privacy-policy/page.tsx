      ...
      <div className="space-y-12 text-md md:text-lg text-gray-500 pb-4 md:pb-8">
        ...
        <div className="space-y-2">
          ...
          <p>
            ...
            experience. The only data we collect is through Google Analytics,
            which includes: Usage Information: We may collect information about
        ...
        <div className="space-y-2">
          ...
          <p>
            ...
            privacy policies, or practices of these third-party websites. We
        ...
        <div className="space-y-2">
          ...
          <p>
            ...
            upon posting on this page, and the date of the latest revision will
